...
<form id="regForm">
	...
	<div class="tab">
		...
		<div class="row" style="width: 100%;">
			<span class="col-md-12" style="text-align: center;"><label>Αναγνωριστικό επιχείρησης</label> <br><input id="afm" placeholder="π.χ. 0123456789" value="<?php echo $_SESSION["bsn_afm"]; ?>" pattern="[0-9]{10,}$" oninput="this.className = ''" name="fname"></span>
		</div>
	</div>
	<div class="tab">
		<h3 style="text-align: center">Ιστορικό δηλώσεων</h3>
...
<?php if ($sessionFlag == 2) { ?>
	<div class="row" style="width:100%;">
		...
		<h5> Για να χρησιμοποιήσετε το Ιστορικό Δηλώσεων για τις επιχειρήσεις, <br>θα πρέπει να έχετε συνδεθεί με επιχειρησιακό προφίλ.</h5>
		<br>
...
function nextPrev(n) {
	...
	if (n == 1) {
		...
		showBusinessEmployeesReportHtml2(businessAfm);
	}
